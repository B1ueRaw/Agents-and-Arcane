...
public class HexMapEditor : MonoBehaviour
{
	...
	void CreateUnit()
	{
		string unit_name = "Mad Mage";
		string background = "Genius mage who is the top of their class will always home in on their target";
        HexCell cell = GetCellUnderCursor();
		if (cell && !cell.Unit)
        {
            unitManager.CreateUnit(unit_name, background, "Mage", 5, cell.Coordinates, false);
		}
	}
	...
	void CreateFighter()
	{
		...
		{
			hexGrid.AddUnit(
				Instantiate(hexGrid.fighterPrefab), cell, Random.Range(0f, 360f)
			);
		}
	}
	...
	void CreateGolem()
	{
		...
		{
			hexGrid.AddUnit(
				Instantiate(hexGrid.golemPrefab), cell, Random.Range(0f, 360f)
			);
		}
	}
