...
public struct HexCellData
{
    ...
    /// <summary>
    /// Cell values extended.
    /// </summary>
    public HexValuesExtended valuesExtended;
    ...
    /// Resource type index.
    /// </summary>
    public readonly int ResourceTypeIndex => valuesExtended.ResourceTypeIndex;
    ...
    /// Mana feature level.
    /// </summary>
    public readonly int ManaLevel => valuesExtended.ManaLevel;

    /// <summary>
    /// Resource feature level.
    /// </summary>
    public readonly int ResourceLevel => valuesExtended.ResourceLevel;

	/// <summary>
	/// Whether the cell has resources.
	/// </summary>
	public readonly bool HasResource => valuesExtended.ResourceLevel > 0;

    /// <summary>
    /// Whether the cell has mana.
    /// </summary>
    public readonly bool HasMana => valuesExtended.ManaLevel > 0;
	...
	{
		string _json = $"{{\"x_coord\": {coordinates.X},\"y_coord\": {coordinates.Z},\"type\": {ResourceTypeIndex},\"tier\": {ResourceLevel}}}";
		return _json;
	}
}
